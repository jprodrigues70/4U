            ...
            <div class="card">
                <div class="post">
                    <div class="post-header">
                        <img src="../assets/img/pp.jpeg" alt="">
                        <h4>Mateus Cordeiro</h4>
                        <span>23 AGO 2015, 22:01</span>
                    ...
                    <div class="post-body">
                        <div class="">
                            <p>Galera, esse aqui é o meu trabalho de formais.</p>
                        </div>
                        <div class="tags">
                            <div class="tag">Computação</div>
                            <div class="tag" style="border-color: #ff8a84">MATA68</div>
                        </div>
                ...
                <div class="comments-box">
                    ...
                    <div class="do-comment">
                        <img src="../assets/img/pp.jpeg" alt="">
                        <input type="text" class="comment-block" placeholder="Deixe um comentário">
